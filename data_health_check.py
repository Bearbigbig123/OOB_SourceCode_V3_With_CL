...
if __name__ == "__main__":
    ...
    # 預設使用相對路徑，若不存在則開啟檔案選擇對話框
    default_excel_path = os.path.join(os.path.dirname(__file__), "input", "All_Chart_Information.xlsx")
    if os.path.exists(default_excel_path):
        test_excel_path = default_excel_path
        test_raw_data_dir = os.path.dirname(default_excel_path)
    else:
